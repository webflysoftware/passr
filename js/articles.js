    ...
    body: `
      ...
      <section class="platform-entry">
        <figure class="platform-entry-banner">
          ...
          <picture>
            <source srcset="/images/trivia/triviarat.webp" type="image/webp">
            <img src="/images/trivia/triviarat.jpg" alt="TriviaRat pub quiz hosting interface" width="1672" height="941" loading="lazy">
          </picture>
        </figure>
        ...
        <div class="platform-details">
          ...
          <div class="platform-cons">
            ...
            <ul>
              ...
              <li>Built for in-room events; 500 remote players can lag the host UX</li>
              <li>English only</li>
            </ul>
          </div>
        </div>
        ...
        <div class="platform-details">
          <div class="platform-pros">
            ...
            <ul>
              ...
              <li>Running in ten minutes is realistic</li>
            </ul>
          </div>
          <div class="platform-cons">
            <p><strong>Cons</strong></p>
