...
export const config = {
  ...
  emailVerificationMinutes: Number(process.env.EMAIL_VERIFICATION_MINUTES || 1440),
  siteUrl: (process.env.SITE_URL || "https://passr.net").replace(/\/$/, ""),
  postmarkApiToken: process.env.POSTMARK_API_TOKEN || "",
  postmarkMessageStream: process.env.POSTMARK_MESSAGE_STREAM || "outbound",
  mailFrom: process.env.POSTMARK_FROM || process.env.SMTP_FROM || "PASSR <hello@passr.net>",
